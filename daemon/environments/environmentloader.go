...
import (
	...
	"github.com/pufferpanel/pufferpanel/v3/daemon/environments/docker"
	"path/filepath"
	"sync"
)

var mapping map[string]daemon.EnvironmentFactory

func LoadModules() {
	mapping = make(map[string]daemon.EnvironmentFactory)
...
func Create(environmentType, folder, id string, environmentSection interface{}) (daemon.Environment, error) {
