...
func (c SteamGameDl) Run(env daemon.Environment) (err error) {
	...
	if code != 0 {
		return errors.New(fmt.Sprintf("depotdownloader exited with non-zero code: %d", code))
	}
	return nil
}
