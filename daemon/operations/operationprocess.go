...
import (
	...
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/alterfile"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/archive"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/command"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/console"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/download"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/extract"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/fabricdl"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/forgedl"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/mkdir"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/mojangdl"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/move"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/sleep"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/spongeforgedl"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/steamgamedl"
	"github.com/pufferpanel/pufferpanel/v3/daemon/operations/writefile"
	"github.com/spf13/cast"
)

var commandMapping map[string]daemon.OperationFactory

func LoadOperations() {
	commandMapping = make(map[string]daemon.OperationFactory)

	loadCoreModules()
}

func GenerateProcess(directions []interface{}, environment daemon.Environment, dataMapping map[string]interface{}, env map[string]string) (OperationProcess, error) {
	...
	operationList := make([]daemon.Operation, 0)
	for _, mapping := range directions {
		...
		opCreate := daemon.CreateOperation{
...
type OperationProcess struct {
	processInstructions []daemon.Operation
}

func (p *OperationProcess) Run(env daemon.Environment) (err error) {
	for p.HasNext() {
		err = p.RunNext(env)
		if err != nil {
			break
...
func (p *OperationProcess) RunNext(env daemon.Environment) error {
