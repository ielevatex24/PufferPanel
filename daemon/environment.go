...
type Environment interface {
	...
	AddListener(ws *pufferpanel.Socket)

	GetStats() (*pufferpanel.ServerStats, error)
...
type BaseEnvironment struct {
	...
	WSManager         *pufferpanel.Tracker `json:"-"`
...
func (e *BaseEnvironment) AddListener(ws *pufferpanel.Socket) {
