...
func CreateEnvironment() *Environment {
	t := &Environment{
		BaseEnvironment: &daemon.BaseEnvironment{Type: "standard"},
	}
...
func (s *Environment) standardExecuteAsync(steps daemon.ExecutionData) (err error) {
